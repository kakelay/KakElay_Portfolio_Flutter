...
class StringConst {
  //strings
  static const String APP_NAME = "KakElay Portfolio";
  ...
  static const String ABOUT_ME_DESC =
      "I'm a skilled Flutter developer with over 1 year of dedicated experience in mobile app development. My proficiency in Flutter allows me to build robust and engaging apps tailored to your specific requirements. Whether you have a unique app concept or need improvements to an existing one, I'm here to turn your ideas into reality. Let's work together to craft exceptional mobile experiences.";
  ...
  static const String CREATIVE_DESIGN = "Need Creative MobileApp?";
