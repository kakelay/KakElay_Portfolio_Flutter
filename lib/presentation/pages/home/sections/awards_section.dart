...
import 'package:kakelay_portfolio/presentation/widgets/bullet_text.dart';
import 'package:kakelay_portfolio/presentation/widgets/content_area.dart';
import 'package:kakelay_portfolio/presentation/widgets/nimbus_info_section.dart';
        ...
        children: [
          Stack(
            children: [
              ...
              Image.asset(
                ImagePath.DEV_AWARD_KAKELAY,
              ),
              AnimatedPositioned(
                left: text1InView ? textPosition : -300,
              ...
              AnimatedPositioned(
                right: text2InView ? textPosition : -300,
